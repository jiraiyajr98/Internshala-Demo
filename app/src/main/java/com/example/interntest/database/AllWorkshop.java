...
public class AllWorkshop extends SQLiteOpenHelper {

    //Current Single Table Name
    private static final String table_name = "AllWorkshops";


    private static final String WORKSHOP_NAME = "WORKSHOP_NAME";


    private static final String WORKSHOP_DETAILS = "WORKSHOP_DETAILS";

    //TAG to Check and debug
    private static final String TAG = "SQLDB";

    //Constructor to initialize
    public AllWorkshop(Context context){
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String create_table="CREATE TABLE IF NOT EXISTS "+table_name+"(_id INTEGER PRIMARY KEY AUTOINCREMENT, " +
                WORKSHOP_NAME +" TEXT,"+WORKSHOP_DETAILS+" TEXT)";
        db.execSQL(create_table);

    }

    //Add to this particular table
    public void addsqlData(String name,String details){
        ...
        cv.put(WORKSHOP_DETAILS,details);
        db.insert(table_name,null,cv);
        db.close();
        Log.d(TAG,"Inserting "+name+" : "+details);
    }
